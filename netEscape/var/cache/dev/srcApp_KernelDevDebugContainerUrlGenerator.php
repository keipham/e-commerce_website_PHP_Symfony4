...
class srcApp_KernelDevDebugContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'admin_users_index' => array(array(), array('_controller' => 'App\\Controller\\AdminController::indexUsers'), array(), array(array('text', '/admin/users')), array(), array()),
        'admin_users_new' => array(array(), array('_controller' => 'App\\Controller\\AdminController::newUser'), array(), array(array('text', '/admin/users/new')), array(), array()),
        'admin_games_index' => array(array(), array('_controller' => 'App\\Controller\\AdminController::indexGames'), array(), array(array('text', '/admin/games')), array(), array()),
        'admin_games_new' => array(array(), array('_controller' => 'App\\Controller\\AdminController::newGame'), array(), array(array('text', '/admin/games/new')), array(), array()),
        'admin_games_edit' => array(array('id'), array('_controller' => 'App\\Controller\\AdminController::editGame'), array(), array(array('text', '/edit'), array('variable', '/', '[^/]++', 'id', true), array('text', '/admin/games')), array(), array()),
        'admin_games_delete' => array(array('id'), array('_controller' => 'App\\Controller\\AdminController::deleteGame'), array(), array(array('variable', '/', '[^/]++', 'id', true), array('text', '/admin/games')), array(), array()),
        'formulas_new' => array(array(), array('_controller' => 'App\\Controller\\AdminController::newFormula'), array(), array(array('text', '/admin/new')), array(), array()),
        'formulas_edit' => array(array('id'), array('_controller' => 'App\\Controller\\AdminController::editFormula'), array(), array(array('text', '/edit'), array('variable', '/', '[^/]++', 'id', true), array('text', '/admin')), array(), array()),
        'formulas_delete' => array(array('id'), array('_controller' => 'App\\Controller\\AdminController::deleteFormula'), array(), array(array('variable', '/', '[^/]++', 'id', true), array('text', '/admin')), array(), array()),
        ...
        'formulas_show' => array(array('id'), array('_controller' => 'App\\Controller\\FormulasController::showFormula'), array(), array(array('variable', '/', '[^/]++', 'id', true), array('text', '/formulas')), array(), array()),
        'games_index' => array(array(), array('_controller' => 'App\\Controller\\GamesController::indexUser'), array(), array(array('text', '/games/games/')), array(), array()),
        'games_show' => array(array('id'), array('_controller' => 'App\\Controller\\GamesController::show'), array(), array(array('variable', '/', '[^/]++', 'id', true), array('text', '/games/games')), array(), array()),
        'home' => array(array(), array('_controller' => 'App\\Controller\\SecurityController::index'), array(), array(array('text', '/')), array(), array()),
